...
public class prueba02 {
    ...
    public static void main(String[] args) {
        ...
        TarjetaCredito pago1 = new TarjetaCredito("Bital", "1234123412341234", fechaPago1, "Juan Perez");
        Fecha fechaPago2 = new Fecha(11, 12, 2018);
        TarjetaCredito pago2 = new TarjetaCredito("Banco Mexicano", "182713401331897", fechaPago2, "Juan Perez");

        Efectivo pago3 = new Efectivo();
